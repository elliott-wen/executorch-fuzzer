...
build_call_args walks a PyTorch op's named params, materialises each via the
builders, applies special-arg coercion, and enforces foreach Scalar[]/Tensor[]
length-sync. Returns ConcreteArgs (args + witness + errors).
"""
