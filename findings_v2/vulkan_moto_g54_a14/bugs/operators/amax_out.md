...
Bisected from corpus job `w107:127` `out[0]`. The op was rebuilt as a **one-op graph fed its
...
- sample idx [0] — device [-6.917529027641082e+18]

## Reproduce
```
python findings_v2/vulkan_moto_g54_a14/bugs/operators/repro_amax_out.py
```
