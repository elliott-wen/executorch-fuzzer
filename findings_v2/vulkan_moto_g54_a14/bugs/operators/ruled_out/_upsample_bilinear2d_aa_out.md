# RULED OUT — `_upsample_bilinear2d_aa.out`
...
Bisected from corpus job `w120:1092` `out[2]`. The op was rebuilt as a **one-op graph fed its
...
## Reproduce
```
python findings_v2/vulkan_moto_g54_a14/bugs/operators/repro__upsample_bilinear2d_aa_out.py
```
