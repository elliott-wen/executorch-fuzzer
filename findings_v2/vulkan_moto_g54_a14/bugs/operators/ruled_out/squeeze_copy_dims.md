...
# Vulkan operator bug — `squeeze_copy.dims`
...
Bisected from corpus job `w101:613` `out[0]`. The op was rebuilt as a **one-op graph fed its
...
## Reproduce
```
python findings_v2/vulkan_moto_g54_a14/bugs/operators/repro_squeeze_copy_dims.py
```
