...
# Vulkan operator bug — `squeeze_copy.dim`
...
Bisected from corpus job `w101:1069` `out[1]`. The op was rebuilt as a **one-op graph fed its
...
## Reproduce
```
python findings_v2/vulkan_moto_g54_a14/bugs/operators/repro_squeeze_copy_dim.py
```
