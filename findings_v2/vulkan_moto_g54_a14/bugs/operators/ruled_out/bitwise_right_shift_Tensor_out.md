# RULED OUT — `bitwise_right_shift.Tensor_out`
...
# Vulkan operator bug — `bitwise_right_shift.Tensor_out`
...
Bisected from corpus job `w109:511` `out[2]`. The op was rebuilt as a **one-op graph fed its
...
## Reproduce
```
python findings_v2/vulkan_moto_g54_a14/bugs/operators/repro_bitwise_right_shift_Tensor_out.py
```
