...
# Vulkan operator bug — `bitwise_or.Scalar`
...
Bisected from corpus job `w112:46` `out[1]`. The op was rebuilt as a **one-op graph fed its
...
## Reproduce
```
python findings_v2/vulkan_moto_g54_a14/bugs/operators/repro_bitwise_or_Scalar.py
```
