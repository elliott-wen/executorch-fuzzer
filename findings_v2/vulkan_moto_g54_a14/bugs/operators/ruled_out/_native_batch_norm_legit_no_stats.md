# RULED OUT — `_native_batch_norm_legit.no_stats`
...
# Vulkan operator bug — `_native_batch_norm_legit.no_stats`
...
Bisected from corpus job `w3:733` `out[0]`. The op was rebuilt as a **one-op graph fed its
...
## Reproduce
```
python findings_v2/vulkan_moto_g54_a14/bugs/operators/repro__native_batch_norm_legit_no_stats.py
```
