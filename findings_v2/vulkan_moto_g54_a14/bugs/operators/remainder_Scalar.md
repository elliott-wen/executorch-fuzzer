# Vulkan operator bug — `remainder.Scalar`
...
Bisected from corpus job `w100:110` `out[0]`. The op was rebuilt as a **one-op graph fed its
...
- **worst element** (idx 0): eager **4.0** vs device **-3.0**
- input dtypes: ['torch.int64']
- sample idx [0, 1, 2] — eager  [4.0, 4.0, 4.0]
- sample idx [0, 1, 2] — device [-3.0, -3.0, -3.0]

## Reproduce
```
python findings_v2/vulkan_moto_g54_a14/bugs/operators/repro_remainder_Scalar.py
```
