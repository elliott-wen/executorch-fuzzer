#!/usr/bin/env python3
"""Repro: Vulkan operator bug `pow.Tensor_Scalar_out` on Moto G54 5G (Android 14).
Single-op graph fed the op's EXACT runtime inputs (baked from corpus job w103:733 out[2]),
