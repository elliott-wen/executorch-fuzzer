# Vulkan operator bug — `bitwise_left_shift.Tensor_out`
...
Bisected from corpus job `w0:732` `out[0]`. The op was rebuilt as a **one-op graph fed its
...
- **worst element** (idx 1): eager **0.0** vs device **-9.223372036854776e+18**
...
## Reproduce
```
python findings_v2/vulkan_moto_g54_a14/bugs/operators/repro_bitwise_left_shift_Tensor_out.py
```
