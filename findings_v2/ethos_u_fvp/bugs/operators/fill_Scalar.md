# Ethos-U operator bug — `fill.Scalar`
...
- **Input dtype(s):** torch.int8
- **eager (reference):** [-1.0, -1.0]
- **device (Ethos-U):** [0.0, 0.0]
- **worst element:** eager `-1.0` vs device `0.0`
- **Source rep:** `w10:1028` out[3]
...
BISECT_BACKEND=ethos-u BISECT_CORPUS=corpus_v2/ethos-u BISECT_QUANTIZE=1 BROKER_PORT=15574 \
  ISO_DEV_TIMEOUT=200 python tmp/isolate_op.py w10:1028 3
```
