# Ethos-U operator bug — `native_layer_norm.default`
...
- **eager (reference):** [NaN, NaN, NaN, NaN, NaN]
- **device (Ethos-U):** [NaN, NaN, NaN, NaN, NaN]
- **worst element:** eager `NaN` vs device `NaN`
- **Source rep:** `w15:278` out[4]
...
BISECT_BACKEND=ethos-u BISECT_CORPUS=corpus_v2/ethos-u BISECT_QUANTIZE=1 BROKER_PORT=15574 \
  ISO_DEV_TIMEOUT=200 python tmp/isolate_op.py w15:278 4
```
