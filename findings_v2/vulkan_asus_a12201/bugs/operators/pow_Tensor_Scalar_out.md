...
Bisected from corpus job `w102:281` `out[0]`. The op was rebuilt as a **one-op graph fed its
...
- divergence: `out[0] max|delta|=3.286e+02 (rtol=0.01 atol=0.001)`
- input dtypes: ['torch.float32']
- eager  (CPU): [-164.27562, -164.27562]
- device (GPU): [164.27554, 164.27554]

## Reproduce
```
python findings_v2/vulkan_asus_a12201/bugs/operators/repro_pow_Tensor_Scalar_out.py
```
