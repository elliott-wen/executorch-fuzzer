...
- divergence: `out[0] max|delta|=8.647e+17 (rtol=0.0 atol=0.0)`
- **worst element** (idx 0): eager **0.0** vs device **-8.646911284551352e+17**
- input dtypes: ['torch.int64']
- sample idx [0] — eager  [0.0]
- sample idx [0] — device [-8.646911284551352e+17]

## Reproduce
```
python findings_v2/vulkan_asus_a12201/bugs/operators/repro_bitwise_left_shift_Tensor_Scalar.py
```
