# RULED OUT — `gather.out`

**Status:** not filed. reproduces eager when it runs (6/7 clean) — NOT a kernel bug.
...
Bisected from corpus job `w101:292` `out[1]`. The op was rebuilt as a **one-op graph fed its
...
## Reproduce
```
python findings_v2/vulkan_asus_a12201/bugs/operators/repro_gather_out.py
```
