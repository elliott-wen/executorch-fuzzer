...
Bisected from corpus job `w11:622` `out[2]`. The op was rebuilt as a **one-op graph fed its
...
## Reproduce
```
python findings_v2/vulkan_asus_a12201/bugs/operators/repro_atanh_out.py
```
