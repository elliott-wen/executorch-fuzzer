...
Bisected from corpus job `w0:283` `out[1]`. The op was rebuilt as a **one-op graph fed its
...
- divergence: `out[0] max|delta|=4.109e+00 (rtol=0.01 atol=0.001)`
- input dtypes: ['torch.float16', 'torch.float16']
- eager  (CPU): [3.97656, 4.34766]
- device (GPU): [-0.13208, 0.23828]

## Reproduce
```
python findings_v2/qnn_emulator/bugs/operators/repro_sub_out.py
```
