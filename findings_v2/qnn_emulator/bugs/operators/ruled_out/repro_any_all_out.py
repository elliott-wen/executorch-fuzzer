#!/usr/bin/env python3
"""Repro: Vulkan operator bug `any.all_out` on QNN HTP x86 emulator (fp16).
Single-op graph fed the op's EXACT runtime inputs (baked from corpus job w101:28 out[2]),
