...
Bisected from corpus job `w102:767` `out[1]`. The op was rebuilt as a **one-op graph fed its
...
## Reproduce
```
python findings_v2/qnn_emulator/bugs/operators/repro_bitwise_right_shift_Tensor_out.py
```
