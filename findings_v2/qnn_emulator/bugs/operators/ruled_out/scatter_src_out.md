...
Bisected from corpus job `w10:379` `out[0]`. The op was rebuilt as a **one-op graph fed its
...
## Reproduce
```
python findings_v2/qnn_emulator/bugs/operators/repro_scatter_src_out.py
```
