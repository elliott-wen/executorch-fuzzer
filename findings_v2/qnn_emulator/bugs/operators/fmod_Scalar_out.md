# Vulkan operator bug — `fmod.Scalar_out`
...
Bisected from corpus job `w100:694` `out[0]`. The op was rebuilt as a **one-op graph fed its
...
## Reproduce
```
python findings_v2/qnn_emulator/bugs/operators/repro_fmod_Scalar_out.py
```
