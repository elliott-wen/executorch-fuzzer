# Ethos-U operator bug — `div.Scalar`
...
- **Divergence:** out[0] shape (2,) vs (2, 2)
- **Input dtype(s):** torch.float32
- **eager (reference):** [-1.0, 0.0]
- **device (Ethos-U):** [0.99951, 0.98242]
- **worst element:** eager `null` vs device `null`
- **Source rep:** `w13:521` out[0]
...
BISECT_BACKEND=ethos-u BISECT_CORPUS=corpus_v2/ethos-u BISECT_QUANTIZE=1 BROKER_PORT=15574 \
  ISO_DEV_TIMEOUT=200 python tmp/isolate_op.py w13:521 0
```
