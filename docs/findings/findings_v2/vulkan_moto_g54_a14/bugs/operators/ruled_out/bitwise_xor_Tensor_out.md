# RULED OUT — `bitwise_xor.Tensor_out`
...
Bisected from corpus job `w100:186` `out[0]`. The op was rebuilt as a **one-op graph fed its
...
- divergence: `out[0] dtype torch.int32 vs torch.float32`
- input dtypes: ['torch.int32', 'torch.int32']
- eager  (CPU): [7.0, 7.0, 7.0, 0.0, 7.0, 5.0]
- device (GPU): [3.0, 4.0, 4.0, 1.0, 3.0, 4.0]

## Reproduce
```
python findings_v2/vulkan_moto_g54_a14/bugs/operators/repro_bitwise_xor_Tensor_out.py
```
