...
# Vulkan operator bug — `select_scatter`
...
Bisected from corpus job `w0:147` `out[0]`. The op was rebuilt as a **one-op graph fed its
...
## Reproduce
```
python findings_v2/vulkan_moto_g54_a14/bugs/operators/repro_select_scatter.py
```
