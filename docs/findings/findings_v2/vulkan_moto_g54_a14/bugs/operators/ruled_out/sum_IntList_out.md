...
# Vulkan operator bug — `sum.IntList_out`
...
Bisected from corpus job `w0:680` `out[1]`. The op was rebuilt as a **one-op graph fed its
...
## Reproduce
```
python findings_v2/vulkan_moto_g54_a14/bugs/operators/repro_sum_IntList_out.py
```
