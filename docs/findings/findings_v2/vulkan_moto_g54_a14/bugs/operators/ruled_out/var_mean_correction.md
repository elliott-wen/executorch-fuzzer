...
# Vulkan operator bug — `var_mean.correction`
...
Bisected from corpus job `w0:77` `out[1]`. The op was rebuilt as a **one-op graph fed its
...
## Reproduce
```
python findings_v2/vulkan_moto_g54_a14/bugs/operators/repro_var_mean_correction.py
```
