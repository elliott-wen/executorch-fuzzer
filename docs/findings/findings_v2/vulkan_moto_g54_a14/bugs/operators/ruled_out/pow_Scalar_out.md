...
Bisected from corpus job `w116:575` `out[2]`. The op was rebuilt as a **one-op graph fed its
...
## Reproduce
```
python findings_v2/vulkan_moto_g54_a14/bugs/operators/repro_pow_Scalar_out.py
```
