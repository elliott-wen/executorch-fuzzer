...
- divergence: `out[0] dtype torch.bool vs torch.uint8`
- input dtypes: ['torch.bool']
- sample idx [0, 1] — eager  [1.0, 1.0]
- sample idx [0, 1] — device [253.0, 255.0]

## Reproduce
```
python findings_v2/vulkan_moto_g54_a14/bugs/operators/repro_fill_Scalar.py
```
