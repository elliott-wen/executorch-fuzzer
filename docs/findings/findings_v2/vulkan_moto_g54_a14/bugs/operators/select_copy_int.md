# Vulkan operator bug — `select_copy.int`
...
Bisected from corpus job `w106:747` `out[0]`. The op was rebuilt as a **one-op graph fed its
...
- divergence: `out[0] max|delta|=1.667e-01 (rtol=0.01 atol=0.001)`
- **worst element** (idx 0): eager **-0.16667** vs device **-0.0**
- input dtypes: ['torch.float32']
- sample idx [0, 1, 2, 3, 4] — eager  [-0.16667, -0.16667, -0.16667, -0.16667, -0.16667]
- sample idx [0, 1, 2, 3, 4] — device [-0.0, -0.16667, -0.16667, -0.16667, -0.0]

## Reproduce
```
python findings_v2/vulkan_moto_g54_a14/bugs/operators/repro_select_copy_int.py
```
