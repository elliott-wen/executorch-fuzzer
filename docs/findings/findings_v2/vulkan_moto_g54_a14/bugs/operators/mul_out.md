...
Bisected from corpus job `w101:738` `out[3]`. The op was rebuilt as a **one-op graph fed its
...
- divergence: `out[0] max|delta|=5.042e+21 (rtol=0.01 atol=0.001)`
- **worst element** (idx 0): eager **5.0418833656327e+21** vs device **-0.0**
- input dtypes: ['torch.float32', 'torch.int64']
- sample idx [0, 1, 2, 3] — eager  [5.0418833656327e+21, 4.096481257930621e+19, -0.0, -0.0]
- sample idx [0, 1, 2, 3] — device [-0.0, -0.0, -0.0, -0.0]

## Reproduce
```
python findings_v2/vulkan_moto_g54_a14/bugs/operators/repro_mul_out.py
```
