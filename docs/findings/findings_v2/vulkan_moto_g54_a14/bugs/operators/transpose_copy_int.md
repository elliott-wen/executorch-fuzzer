# Vulkan operator bug — `transpose_copy.int`
...
Bisected from corpus job `w0:196` `out[2]`. The op was rebuilt as a **one-op graph fed its
...
- divergence: `out[0] dtype torch.int64 vs torch.float16`
- input dtypes: ['torch.int64']
- sample idx [0, 1, 2, 3, 4] — eager  [0.0, 0.0, 0.0, 4.0, 0.0]
- sample idx [0, 1, 2, 3, 4] — device [0.43628, 0.43628, 0.43628, 0.43628, 0.43628]

## Reproduce
```
python findings_v2/vulkan_moto_g54_a14/bugs/operators/repro_transpose_copy_int.py
```
