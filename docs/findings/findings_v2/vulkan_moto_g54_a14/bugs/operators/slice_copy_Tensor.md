# Vulkan operator bug — `slice_copy.Tensor`
...
Bisected from corpus job `w100:336` `out[1]`. The op was rebuilt as a **one-op graph fed its
...
- divergence: `out[0] max|delta|=1.164e+00 (rtol=0.01 atol=0.001)`
- **worst element** (idx 1): eager **1.16359** vs device **0.0**
- input dtypes: ['torch.float32']
- sample idx [0, 1] — eager  [0.0, 1.16359]
- sample idx [0, 1] — device [0.0, 0.0]

## Reproduce
```
python findings_v2/vulkan_moto_g54_a14/bugs/operators/repro_slice_copy_Tensor.py
```
