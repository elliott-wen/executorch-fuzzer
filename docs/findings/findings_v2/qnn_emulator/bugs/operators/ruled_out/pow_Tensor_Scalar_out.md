# RULED OUT — `pow.Tensor_Scalar_out`
...
Bisected from corpus job `w100:160` `out[0]`. The op was rebuilt as a **one-op graph fed its
...
## Reproduce
```
python findings_v2/qnn_emulator/bugs/operators/repro_pow_Tensor_Scalar_out.py
```
