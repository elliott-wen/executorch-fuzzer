...
Bisected from corpus job `w0:260` `out[0]`. The op was rebuilt as a **one-op graph fed its
...
- divergence: `out[0] max|delta|=1.464e+01 (rtol=0.01 atol=0.001)`
...
## Reproduce
```
python findings_v2/qnn_emulator/bugs/operators/repro_elu_out.py
```
