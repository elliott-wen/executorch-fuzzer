#!/usr/bin/env python3
"""Repro: Vulkan operator bug `any.all_out` on ASUS a12201 (Vulkan).
Single-op graph fed the op's EXACT runtime inputs (baked from corpus job w0:781 out[4]),
