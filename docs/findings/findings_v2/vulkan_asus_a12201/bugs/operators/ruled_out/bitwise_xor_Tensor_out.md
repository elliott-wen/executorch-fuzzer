...
Bisected from corpus job `w100:386` `out[0]`. The op was rebuilt as a **one-op graph fed its
...
## Reproduce
```
python findings_v2/vulkan_asus_a12201/bugs/operators/repro_bitwise_xor_Tensor_out.py
```
