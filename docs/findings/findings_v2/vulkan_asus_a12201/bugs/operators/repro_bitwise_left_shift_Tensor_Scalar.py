#!/usr/bin/env python3
"""Repro: Vulkan operator bug `bitwise_left_shift.Tensor_Scalar` on Moto G54 5G (Android 14).
Single-op graph fed the op's EXACT runtime inputs (baked from corpus job w101:183 out[0]),
