#!/usr/bin/env python3
"""Replay: bitwise_left_shift negative count -> C++ UB magic number vs eager 0.

Usage: cd /data/jwen929/mobile && .venv/bin/python findings/portable/bugs/replay_bitwise-shift-negative.py
"""
...
JOB = "corpus/portable/w0/w0_1066.py"   # bitwise_left_shift.Tensor_Scalar(n1, -3)
