#!/usr/bin/env python3
"""Replay: prod/reduction written into a narrower bool out= tensor diverges
(any-vs-product / saturation handled differently by portable vs eager).

Usage: cd /data/jwen929/mobile && .venv/bin/python findings/portable/bugs/replay_reduction-into-bool-out.py
"""
...
JOB = "corpus/portable/w0/w0_101.py"   # prod.int_out(n2, 0, …, out bool)
OUT = 3                                 # offending USER_OUTPUT index
