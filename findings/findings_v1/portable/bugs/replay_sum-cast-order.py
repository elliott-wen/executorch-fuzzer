#!/usr/bin/env python3
"""Replay: sum(float in / int64 out, dtype=None) accumulate-then-cast vs cast-then-accumulate.

Usage: cd /data/jwen929/mobile && .venv/bin/python findings/portable/bugs/replay_sum-cast-order.py
"""
...
JOB = "corpus/portable/w0/w0_707.py"    # sum.IntList_out(n0, None, True, dtype=None, out=int64)
OUT = 5                                  # offending USER_OUTPUT index
