...
Bisected from corpus job `w44:561` `out[0]`. The op was rebuilt as a **one-op graph fed its
...
## Reproduce
```
python findings_v2/vulkan_asus_a12201/bugs/operators/repro__native_batch_norm_legit_no_stats.py
```
