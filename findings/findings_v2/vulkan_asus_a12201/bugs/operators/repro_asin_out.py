#!/usr/bin/env python3
"""Repro: Vulkan operator bug `asin.out` on Moto G54 5G (Android 14).
Single-op graph fed the op's EXACT runtime inputs (baked from corpus job w105:732 out[1]),
