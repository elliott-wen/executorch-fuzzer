...
Bisected from corpus job `w102:718` `out[0]`. The op was rebuilt as a **one-op graph fed its
...
- divergence: `out[0] max|delta|=5.531e-01 (rtol=0.01 atol=0.001)`
- **worst element** (idx 8): eager **0.75311** vs device **1.30619**
- input dtypes: ['torch.float32']
- sample idx [0, 1, 2, 3, 4, 8] — eager  [1.30619, 1.30619, 1.30619, 1.30619, 1.30619, 0.75311]
- sample idx [0, 1, 2, 3, 4, 8] — device [1.30619, 1.30619, 1.30619, 1.30619, 1.30619, 1.30619]

## Reproduce
```
python findings_v2/vulkan_moto_g54_a14/bugs/operators/repro_abs_out.py
```
