...
Bisected from corpus job `w106:305` `out[0]`. The op was rebuilt as a **one-op graph fed its
...
- **worst element** (idx 1): eager **0.0** vs device **3.0**
...
## Reproduce
```
python findings_v2/qnn_emulator/bugs/operators/repro__native_batch_norm_legit_no_stats.py
```
