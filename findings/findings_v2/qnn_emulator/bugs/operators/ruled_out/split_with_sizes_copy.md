# RULED OUT — `split_with_sizes_copy`
...
Bisected from corpus job `w0:171` `out[2]`. The op was rebuilt as a **one-op graph fed its
...
## Reproduce
```
python findings_v2/qnn_emulator/bugs/operators/repro_split_with_sizes_copy.py
```
