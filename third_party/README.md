...
| dir | SDK | consumed by |
|---|---|---|
| `neuropilot_sdk/` | MediaTek NeuroPilot Express 8.0.8 (build 20250925) | `mediatek` backend; `android_client/build_et_aar.sh` (`NEURON_SDK_ROOT`); py3.10 `.venv-mtk` — see its `README-venv-mtk.md` |
...
| `cadence_sdk/` | Cadence Xtensa Xplorer 11.1.5 + RJ-2025.5 toolchain (RT600 HiFi4) | `local_client/cadence_client/xtensa_env.sh` (`XTENSA_SDK`) for `xt-run` / `xt-clang` |
